...
Components take two styling props. `variant` sets emphasis — `solid`, `soft`, `ghost`, or
...
The two axes are independent, and every combination is valid. `solid` usually carries a
